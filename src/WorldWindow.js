...
define([
    ...
    function (ArcBallCamera,
         ...
         * @param {WorldWindowController} controllerConstructor A controller constructor to be used.
         ...
         */
        var WorldWindow = function (canvasElem, elevationModel, controllerConstructor, cameraConstructor) {
